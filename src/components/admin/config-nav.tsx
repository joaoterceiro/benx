...
import { MessageCircle, Menu, Search, MonitorPlay, Users, GalleryHorizontalEnd, PanelBottom, ScrollText, ListOrdered, Stamp, FileText, Newspaper, Images } from "lucide-react";
