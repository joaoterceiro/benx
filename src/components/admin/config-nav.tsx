...
import { MessageCircle, Menu, Search, MonitorPlay, Users, GalleryHorizontalEnd, PanelBottom, ScrollText, ListOrdered, Stamp, FileText, Newspaper, DraftingCompass } from "lucide-react";
...
const SECOES = [
  ...
  { href: "/admin/configuracoes/arquitetos", label: "Arquitetos", icon: DraftingCompass },
